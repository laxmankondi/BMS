...
const NavLg = () => {
    ...
    <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <span className="text-gray-200 text-xs flex items-center hover:text-white cursor-pointer">Bengaluru <BiChevronDown/></span>
        <button className="bg-red-600 text-white px-2 py1 text-sm rounded">sign in</button>
        <div className="w-8 h-5 text-white">
